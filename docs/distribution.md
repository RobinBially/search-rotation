...
| Glama | [directory entry](https://glama.ai/mcp/servers/localfoundry/search-rotation-mcp), rated A | Glama indexes the repository on its own | listed; Glama followed the rename on its own |
